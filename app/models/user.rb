class User < ApplicationRecord
    ...
    has_secure_password
    validates :email, uniqueness:  {message: "Такой пользователь уже зарегистрирован"}, 
                      presence: {message: "Укажите email"}, format: { with: VALID_EMAIL, message: " Некорректный email "}
